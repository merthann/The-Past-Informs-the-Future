...
# Match ID dosyası
match_ids_file = script_dir / "match_ids_1140.json"
...
for idx, match_info in enumerate(all_matches, 1):
    ...
    # SADECE premier_league klasörüne bak (bu dosya sadece Premier League için)
    ...
    # Önce 45, 60, 75, 90'ın hepsinin olup olmadığını kontrol et (sadece premier_league klasöründe)
    ...
    # Eğer 45, 60, 75, 90 varsa, sadece 30'u kontrol et (sadece premier_league klasöründe)
