...
Usage:
    ...
    python3 train_model.py --cache_dir ../cache --pred_min 90 (--k 4) --fibonacci (k = 4 default, starting from 2->3,5,8)
"""
...
def train_model(
    ...
    if use_fibonacci:
        log_file = f"model4_k{k}_Nfib_{pred_min}min.log"
        interval_str = "Fibonacci (2,3,5,8,...)"
    else:
        log_file = f"model4_k{k}_N{N}_{pred_min}min.log"
